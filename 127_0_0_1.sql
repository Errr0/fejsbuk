...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2025 at 11:24 AM
...
-- Database: `fejsbuk`
--
CREATE DATABASE IF NOT EXISTS `fejsbuk` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fejsbuk`;
...
(1, 'admin', 'n4YOZYd7i+RpVMIYKOyulA==', 2),
(3, 'user', 'eRKy/W+tKqjCfkLsTdgOug==', 0);
...
('root', '2025-02-21 10:24:11', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
